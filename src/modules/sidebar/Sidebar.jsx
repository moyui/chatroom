...
class Sidebar extends Component {
    ...
    static resetThume() {
        action.serPrimaryColor(config.primaryColor);
    ...
    handlePrimaryColorChange(color) {
        ...
        action.setPrimaryColor(primaryColor);
    ...
    handlePrimaryTextColorChange(color) {
        ...
        action.setPrimaryTextColor(primaryTextColor);
        setCssVariable(primaryColor, primaryTextColor);
    }
        ...
        if (isLogin) {
            return (
                <div className="module-main-sidebar">
                    ...
                    <OnlineStatus class="status" status={isConnect ? 'online' : 'offline'} />
                    <div className="buttons">
                        ...
                        {/* 保证不被钓鱼链接 */}
                        <a href="https://github.com/moyui" target="_black" rel="noopener noreferrer">
